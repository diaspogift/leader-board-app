module Runner exposing (Model, Msg, update, view, initModel, init)
...
update msg model =
    case msg of
        NameInput name ->
            ( { model | name = name, nameError = Nothing }, Cmd.none )

        LocationInput location ->
            ( { model | location = location, locationError = Nothing }, Cmd.none )
